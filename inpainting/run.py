...
from inpainting.dataset import Dataset
from inpainting.model import RFRNetModel
...
def run():
    ...
    if args.test:
        ...
        dataloader = DataLoader(
            Dataset(args.data_root, args.mask_root, args.mask_mode, args.target_size, mask_reverse=True)
        )
