...
class RFRModule(nn.Module):
    def __init__(self, layer_size=6, in_channel=64):
        ...
        for i in range(5, 3, -1):
            name = f"dec_{i:d}"
            block = [
                nn.Conv2d(in_channel + in_channel, in_channel, 3, 1, 2, dilation=2, bias=False),
        ...
        block = [nn.ConvTranspose2d(384, 64, 4, 2, 1, bias=False), nn.BatchNorm2d(64), nn.LeakyReLU(0.2, inplace=True)]
